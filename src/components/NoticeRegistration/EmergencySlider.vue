    ...
    >
      <swiper-slide>
        <div class="slider-wrap">
          <img class="img-wd-100"
              src="@/assets/images/emergency-img.jpg"
              alt="" />
          </div>
      </swiper-slide>
      <swiper-slide>
...
//   import { inject } from "@vue/runtime-core";
  ...
  //         data
  //       );
  //       const objIndex = listOfEmergencyData.lists.findIndex((obj => obj.job_id === id))
  ...
  //   };
  //   const sortOfferList = () => {
  //       listOfEmergencyData.lists = listOfEmergencyData.lists.sort((a, b) => Number(b.is_scraps) - Number(a.is_scraps));
  //   };
