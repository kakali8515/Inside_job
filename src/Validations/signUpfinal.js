...
const signUpfinalValidation = (data) => {
  let errors = {};
  ...
  if (validator.isEmpty(cName)) {
    errors.cName = "기업명을 입력해 주세요";
    errors.require = true
  }
  if (validator.isEmpty(czcode)) {
    errors.czcode = "기업명을 입력해주세요.";
    errors.require = true
  }
  if (validator.isEmpty(caddr)) {
    errors.caddr = "기업 주소를 입력해주세요.";
    errors.require = true
  }
  if (validator.isEmpty(cPerson)) {
    errors.cPerson = "담당자명을 입력해주세요.";
    errors.require = true
  }
...
export default signUpfinalValidation;
