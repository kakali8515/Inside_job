<template>
    ...
    height="100%"
    v-slot="{ closeSelf }"
    v-model:visible="commonStore.state.showPaidProductPaymentModal"
  >
            ...
            <div class="mb-197">
                <div class="storage-box-innr no-border">
                    ...
                    <div class="total-amount">
                        ...
                        <p class="red">{{(productDetails.reduce((n, {discounted_price}) => n + discounted_price, 0)).toLocaleString('en-US') }} 초코</p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    props: { productDetails: Array, balance: Number},
    setup() {
