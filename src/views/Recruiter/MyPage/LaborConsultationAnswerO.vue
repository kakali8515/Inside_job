<template>
                ...
                <div class="cm-top-space pb-32">
                    <div class="container">
                        ...
                        <div class="form-group mb-0 ver-center-text">
                            <textarea class="form-control hgt" readonly v-model="consultationOfLaborData.answer" placeholder="등록된 답변이 없습니다.">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Luctus tincidunt non et aliquam risus est vitae. A neque vitae vivamus in ultricies nibh tellus sed eu.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Luctus tincidunt non et aliquam risus est vitae. A neque vitae vivamus in ultricies nibh tellus sed eu.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Luctus tincidunt non et aliquam risus est vitae. A neque vitae vivamus in ultricies nibh tellus sed eu.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Luctus tincidunt non et aliquam risus est vitae. A neque vitae vivamus in ultricies nibh tellus sed eu.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Luctus tincidunt non et aliquam risus est vitae. A neque vitae vivamus in ultricies nibh tellus sed eu. </textarea>
                        </div>
                    </div>
                </div>
            </div>
   ...
   <div v-if="(consultationOfLaborData.answer == null || consultationOfLaborData.answer == '') && userId == loggedInId " class="btm-button-group mt-32 w-50">
...
export default {
  ...
  const editConsultationPage = async () => {
      ...
      router.push({name: 'RecruiterCreateConsultaion', query: queryData})
  }
