                ...
                <div class="outerside">
                    <div class="heading">
                     ...
                     <div class="tab-inner-cont">
                                ...
                                <div v-for="(i, e) in recruiterApplicantUnreadData.lists" :key="e" class="recruiter-applicant-card history-list">
                            ...
                            <ApplicantCard>
                                ...
                                <template v-slot:applicant-rht-content>
                                    <h4 class="mb-8">{{i.resume_title}}</h4>
                                        <span class="cancel-text">입사취소 된 지원서류 입니다.</span>
                                        <ul>                                           
                                            <li class="support-cont">
                                ...
                                <!-- <Pagination v-if="recruiterApplicantUnreadData.totalItem != 0"
                                :totalRecords="recruiterApplicantUnreadData.totalItem"
                ...
                <div class="outerside">
                    <div class="heading">
                     ...
                     <div class="tab-inner-cont">
                        ...
                        <div v-if="recruiterApplicantReadData.lists.length > 0">
                    ...
                    <!-- <Pagination v-if="recruiterApplicantReadData.totalItem != 0"
                    :totalRecords="recruiterApplicantReadData.totalItem"
                ...
                <div class="outerside">
                    <div class="heading">
                     ...
                     <div class="tab-inner-cont">
                        ...
                        <!-- <Pagination v-if="recruiterApplicantBookmarkedData.totalItem != 0"
                    :totalRecords="recruiterApplicantBookmarkedData.totalItem"
...
export default {
  ...
  const fetchRecruiterApplicantUnreadList = async () => {
    let res = await CandidateConfirmationService.recruiterApplicantUnreadListByJob(
  ...
  const fetchRecruiterApplicantReadList = async () => {
    let res = await CandidateConfirmationService.recruiterApplicantReadListByJob(
  ...
  const fetchRecruiterApplicantBookmarkedList = async () => {
    let res = await CandidateConfirmationService.recruiterApplicantBookmarkedListtByJob(
  ...
  const readApplicationForJob = async (data) => {
      try{ 
          ...
          recruiterApplicantUnreadData.lists = recruiterApplicantUnreadData.lists.filter((item) => item.id !== id);
      } catch (e) {
          console.log(e)
      }
  };
