<template>
  <div class="back-wh common-sec">
    <div class="top-hdr no-border">
      <div class="container">
        <InnerHeader headerTitle="회원정보" @backButtonPressed="$router.push('/job-seekers/my-page')"/>
      </div>
    </div>
    <div class="container">
      <div class="mypage-wrapper">
          ...
          <ul class="post-list mb-16">
            ...
            <li v-if="memberData.details.sns_type !== null">
              ...
              <div class="kakao-chng-pwd" v-else-if="memberData.details.sns_type === 'naver'">
                ...
                <p>
                  네이버 로그인을 사용 중 입니다.<br />
                  네이버에서 비밀번호를 바꿀 수 있습니다.
                </p>
              </div>
            ...
            <li v-else>
              <router-link :to="{ name: 'ChangeProgilePassword' }"
                >비밀번호 변경
                <span
                  ><img
                    src="@/assets/icons/right-arrow-large.svg"
        ...
        <div class="pb-32 mypage-cont">
          ...
          <ul class="post-list">
            <li>
              <router-link :to="{ name: 'PushNotification' }"
                >PUSH 알림
                <span
                  ><img
                    src="@/assets/icons/right-arrow-large.svg"
...
<script>
import { inject, onBeforeMount, onMounted, reactive, ref, watch } from "@vue/runtime-core";
...
export default {
  ...
  setup() {
    ...
    watch(() => isLogoutModal.value, async (first, second) => {
        if (isLogoutModal.value == true) {
